...
void print(void)
{
    ...
    if(tempf > 170){
        ret = 0.2493137155*tempf; //add 61.0 is done 
    }    
    if(tempf <= 170)       
        ret = 42.9632047 * log(tempf)-116.259292;
    ret *=10;
    tempi = (long int)floor(ret);
    if(tempf > 170.0)   //add the 62.1 offset
        tempi += 621;
    
    voltf = volt / 7.9438; //3x = 5.9578, 4x = 7.9438
    volt = (long int)floor(voltf);
