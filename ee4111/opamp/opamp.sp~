...
.DC Vi2 -0.5 0.5 0.0001
.PRINT DC V(n4) V(n5) V(n7) I1(M1) I1(M2)
*.PRINT AV V(n2) v(n7)
*.AC DEC 10 10 10E6
.parameter Vid = 0
.parameter Vic = 0
...
M1 n4 n1 n3 nvdd CMOSP W = 40u L = length
M2 n5 n2 n3 nvdd CMOSP W = 40u L = length
M3 n4 n4 nvss nvss CMOSN W = 10u L = length
M4 n5 n4 nvss nvss CMOSN W = 10u L = length
M5 n3 n6 nvdd nvdd CMOSP W = 80u L = length
M6 n7 n5 nvss nvss CMOSN W = 10u L = length
M7 n7 n6 nvdd nvdd CMOSP W = 40u L = length
M8 n6 n6 nvdd nvdd CMOSP W = 8u L = length
