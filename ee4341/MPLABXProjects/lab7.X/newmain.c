...
#define DELAY 320000
// CAN definitions
#define MY_SID 0x123 // 11ญbit CAN frame ID
...
#define MB_SIZE 4       // number of 4ญbyte integers in a message buffer
...
//ญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญ skipping baud settings since loopback only
   C1CONbits.REQOP = 2;                 // request loopback mode 
      while(C1CONbits.OPMOD != 2);      // wait for loopback mode 
//*********************** main loop *********************************** 
// main loop
  while(1) {
// ญญญญญญญญญญญญญญญญญญญญญญ transmit ญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญ
...
// ญญญญญญญญญญญญญญญญญญญญญญ receive ญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญ
     ...
     while(!PORTDbits.RD6); //debounce for all buttons
     while(!PORTDbits.RD7);
     while(!PORTDbits.RD13);
     int j;
     for(j = 0; j<20000; j++); //delay to improve debouncing (switched sensitive)
  }
  return 0;
}
