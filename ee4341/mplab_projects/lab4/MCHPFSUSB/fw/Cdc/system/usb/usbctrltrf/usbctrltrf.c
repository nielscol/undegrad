...
/*******************************************************************/
    ...
    ep0Bi.Stat.BC9 = 0;
    ep0Bi.Stat.BC8 = 0;
    ep0Bi.Stat._byte |= byte_to_send.v[1];
    ep0Bi.Cnt = byte_to_send.v[0]; //LSB(byte_to_send);
...
void USBCtrlTrfRxService(void)
{
    ...
    byte_to_read.v[1] = 0x03 & ep0Bo.Stat._byte;    // Filter out last 2 bits
    byte_to_read.v[0] = ep0Bo.Cnt;
